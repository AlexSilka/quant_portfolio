...
> **Canonical-book note.** Single-family deep-dive. The shipped portfolio is the eight-family equal-weight master book in [REPORT.md](../../REPORT.md) (Sharpe **3.77** full / **3.61** OOS, mean cross-family corr 0.06). Any master-book Sharpe quoted below is the book *snapshot at the time this family was evaluated* (the book grew as families were added, and gmacro became the 7th); the canonical headline is REPORT.md.
