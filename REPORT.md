...
> The book nets **Sharpe 4.38** at **−7.3% max drawdown** — on the brief's **$500k** sizing
> capital that is **$3.39M** of P&L, **~$217k/yr** — **+43.5%/yr** not reinvested,
> **+53.7%/yr** compounded (a rate, not a reachable balance: capacity caps the book long before the end of
...
> **3.87**, months **80.8%**, max-DD **−6.1%**, worst month **−1.8%**, streak **2**).
> On the **full 15-year window** it also clears **4/5** (Sharpe **4.38**, months **82.4%**, max-DD
> **−7.3%**, worst month **−4.7%**, streak **2**). What that changed, measured
> in §6d-ter: **return went up**, not down — +8.3pp of CAGR on the full window,
> +7.9pp on the block — because six legs at equal risk run hotter than eight; the Sharpe reads
> **−0.13** on the block for the same reason, and at matched risk the wider book edges it by
> +0.3pp. **The real price is concentration and breadth**: the short-vol leg's share of P&L up
> from **58% to 65%**, and **no family left that spans both asset classes**.
...
they join, the marginal curve *falls* from volprem's 6.97 toward the combined 4.49 while the shipped
book's worst month is **−4.7%** and max drawdown **−7.3%** — the VIX regime gate flattens the short-vol
tail that used to set the deep months. Remove the anchor (volprem) and a genuine **Sharpe +1.38** book still
stands — decorrelated, positive every year — so it is not one premium alone; the diversifiers buy robustness,
not headline Sharpe. (volprem is 71% of book P&L, so this concentration is itself a stated risk, not a
hidden one.)
...
- **Honest universes, honest levels — now including trend.** Every family uses its **survivorship-free**
  ...
  different reporting windows nets Sharpe **4.20 full-history / 4.42 15-year / 4.28 10-year**, so nothing hinges
  on the early window.
- **Robust, not fitted.** The portfolio is robust because the families are decorrelated — measured
  (block-bootstrap MC-P5 **+3.91**), not asserted — and **positive in 16 of 16 calendar years** 2011–26 (weakest 2026 at +1.4).
  Against the task scorecard, the book scores **5/5 out-of-sample and 4/5 on the full window** — the final out-of-sample block
  (2024-07→, the window the brief scores: Sharpe **3.87**, months-in-profit **80.8%**, max-DD −6.1%, worst month
  −1.8%, streak 2) and the **full 15-year window** (Sharpe **4.38**, months-in-profit **82.4%**, max-DD −7.3%,
...
- **Backtest** — bar-close→execution delay (no same-bar fill), liquidity-aware costs (commission +
  ...
  the book re-charged at **1×/2×/3×** the rebalancing cost it is charged nets Sharpe **+4.38 /
  +4.27 / +4.16** (max-DD −7.3% / −7.5% / −7.6%),
...
- **Sizing capital and what the dollar figures mean (§9).** The brief fixes **$500k of capital for sizing and
  ...
  quoted at that size with **P&L not reinvested**: **$3.39M** over the 15-year window, **~$217k/yr**, worst month
...
cluster the losing months, holding the book at **Sharpe 4.38** and closing the scorecard to
**5/5 out-of-sample, 4/5 on the full window** (§5d/§6). 15-year window 2011→2026; each family joins as it lists, averaged over those live each day. **Mean
...
| **BAB / low-vol** | beta-neutral top-25 crypto, betting-against-beta ([docs/strategies/BAB.md](docs/strategies/BAB.md)) | 1.36 | +0.49 |
| **x-sect momentum** | crypto residual (idio) + equity, top-100 liquid ([docs/strategies/XSECT.md](docs/strategies/XSECT.md)) | 0.95 | +0.45 |
...
- **Master book (risk-managed deliverable, 1.15× = ~10.1% book vol):** full-sample Sharpe **4.38**; on the brief's
  **$500k** sizing capital **$3.39M** of P&L, **~$217k/yr** — **+43.5%/yr**
  not reinvested, **+53.7%/yr** compounded (§9) — max DD **−7.3%**, months-in-profit
  **82.4%**, worst month **−4.7%**, streak **2mo** — **4 of 5 on the
  15-year window** (Sharpe outside the 2.5–4.0 band);
  block-bootstrap MC **[Sharpe P5 +3.91, P50 +4.39, P95 +4.88; max-DD P5 −11.1%, P50 −7.8%]**; mean
  pairwise cross-family correlation **+0.07**. **On the final OOS block: Sharpe 3.87, months-in-profit
  80.8%, max-DD −6.1%, worst −1.8%, streak 2mo — 5/5.**
  Per-family P&L share: **volprem 71%**, gmacro 9%, x-sect 7%, BAB 5%, breakout 5%, crisis 2% — volprem-dominated, stated not hidden.
- **Four-scheme Monte Carlo** (§10, all with P5/P50/P95 of Sharpe, max-DD *and* monthly hit): block bootstrap
  (Sharpe P5 +3.91, the widest), trade-order resample, entry jitter ±1-3 bars, randomised start dates — the
...
- **Marginal contribution** (standalone-descending, on the premium stack, short-vol leg VIX-gated), families
  added in that order: **6.97 → 6.62 → 6.38 → 5.42 → 4.90 → 4.49** — the curve *falls* as diversifiers join: they trade a little
  Sharpe for a much smaller tail (−17.9% at the anchor alone, and along the last four additions
  −13.1% → −8.7% → −6.7% → −6.7%). Removing the anchor (vol-premium) still leaves **+1.38**. `master_book_marginal.csv` carries
...
- **Per-year Sharpe (regime profile):** **positive in all 16 calendar years** 2011–2026 —
  2011 **+2.2** · 2012 **+6.1** · 2013 **+4.9** · 2014 **+5.3** · 2015 **+5.5** · 2016 **+2.9** · 2017 **+6.2** · 2018 **+4.3** · 2019 **+4.7** · 2020 **+3.8** · 2021 **+5.5** · 2022 **+2.9** · 2023 **+5.2** · 2024 **+4.2** · 2025 **+5.0** · 2026 **+1.4** (weakest 2026 at +1.4, a partial year). No down *year*, but through the **isolated crisis windows the book is negative**
...
The equal-weight stack runs at **8.7% annualised volatility** on its own, against a **−15% drawdown mandate**, so
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1.00× | 4.47 | +46.7% | −6.5% | −4.0% | 84.6% | 4/5 | −9.4% | −6.1% | −6.5% | −4.0% |
| **1.15× (shipped)** | **4.48** | **+55.2%** | **−7.2%** | **−4.6%** | **84.6%** | **4/5** | **−10.7%** | **−6.9%** | **−7.2%** | **−4.6%** |
| 1.20× | 4.47 | +58.1% | −7.5% | −4.8% | 84.6% | 4/5 | −11.1% | −7.2% | −7.5% | −4.8% |
| 1.25× | 4.47 | +61.0% | −7.9% | −4.9% | 84.6% | 4/5 | −11.6% | −7.5% | −7.9% | −4.9% |
| 1.35× | 4.48 | +67.0% | −8.0% | −5.0% | 84.0% | 4/5 | −12.3% | −8.0% | −8.0% | −5.0% |
| 1.45× | 4.46 | +72.7% | −8.6% | −5.4% | 83.5% | 3/5 | −13.2% | −8.5% | −8.6% | −5.4% |
| 1.65× | 4.44 | +84.9% | −10.7% | −6.1% | 83.0% | 2/5 | −15.1% | −9.8% | −10.7% | −6.1% |
| 2.00× | 4.42 | +107.5% | −12.5% | −8.3% | 83.0% | 2/5 | −18.1% | −11.7% | −12.5% | −8.3% |

**Sharpe is flat in leverage** (4.48 → 4.41 across the whole grid — the small decay is the §8 overlay, not the
...
**The frozen OOS block scores 5/5 at 2 of the grid's 21 rungs, dropping to 3/5 only at 1.00×, 1.05×, 1.10×, 1.15×, 1.25×, 1.30×, 1.40×, 1.45×, 1.50×, 1.55×, 1.60×, 1.65×, 1.70×, 1.75×, 1.80×, 1.85×, 1.90×, 1.95×, 2.00×** and never sets the choice: Sharpe stays in
**[3.98, 4.11]** and the streak **2** all the way, and only the risk metrics
scale — max-DD **−5.2% → −8.8%**, worst month **−1.6% → −2.1%** from 1.00× to 2.00×
(CAGR 37.0% → 82.5%). That block is a calm two years; it is shown, not used.
...
already runs months-in-profit **80.0%** with a **12-month** losing streak
...
short-vol leg (which carries the tail *and* 71% of P&L) at 1.00× and give the leverage to the other
five. Judged
...
|---|---|---|
| Sharpe (full / OOS) | **4.48 / 4.01** | 4.09 / 3.71 |
| CAGR | **+55.2%** | +49.5% |
| max-DD | **−7.2%** | −7.3% |
| worst month | **−4.6%** | −4.2% |
| months-in-profit | **84.6%** | 83.5% |
...
−5.7pp CAGR, and 1.1pp of months-in-profit, which **breaks the ≥80% target and
...
two books differ on **727 of 5,042 days** — the days `_scale`'s 3× cap binds, which is where the legs are most
levered and the book's worst days live. The result is a *quieter* book at the same nominal size
(−7.9% max-DD against −7.3%, worst month −4.0% against −4.7%, identical
...
- **Portfolio Monte Carlo:** block-bootstrap 5th-percentile Sharpe **+3.91** (full four-scheme table in §4).
...
- **A final out-of-sample block, held to the end and run exactly once** (§10/§11) — `OOS_START=2024-07-01`,
  ...
  so it is the deliverable's scorecard (Sharpe **3.87**, 5/5); the 15-year window is reported
...
- **A rolling & anchored walk-forward with periodic re-fitting** (§10) at the portfolio level
  ...
  track over ~20 years (2006→2026), Sharpe 3.84, max-DD −14.5%** — the book is out-of-sample across nearly the
  ...
  annual re-fit all land Sharpe in **[+3.84, +3.86]** (spread 0.02). **Crisis-window
...
months the standard error of the OOS Sharpe is ±0.70, so 3.87 is 3.87 ±0.70**, and the block is a benign
...
|---|---|---|---|---|---|---|
| **baseline (shipped)** | **+3.91 / +3.58** | **41.1% / 34.0%** | **−7.3%** | **−3.6%** | **81%** | **3** |
| breakout raw (no ML) | +3.90 / +3.69 | 41.1% / 35.6% | −7.3% | −3.6% | 82% | 3 |
| breakout + ML *(shipped)* | +3.91 / +3.58 | 41.0% / 34.0% | −7.3% | −3.5% | 81% | 3 |
| trend raw | +3.91 / +3.58 | 41.1% / 34.0% | −7.3% | −3.6% | 81% | 3 |
| trend + LightGBM gate | +3.91 / +3.58 | 41.1% / 34.0% | −7.3% | −3.6% | 81% | 3 |
| trend + RF gate | +3.91 / +3.58 | 41.1% / 34.0% | −7.3% | −3.6% | 81% | 3 |
| carry + timing overlay | +3.91 / +3.58 | 41.1% / 34.0% | −7.3% | −3.6% | 81% | 3 |
...
3.87 either way (logistic 3.48, boosting 3.76) — and it
**cuts OOS months-in-profit to 81%–85%** (from 80.8%) and returns the
...
**84.6% → 69–72%**, Sharpe **4.36 → 4.01–4.20**, CAGR
**47% → 35–39%** on the full window (compounding **405× →
113–163×** the starting capital), taking the book from **5/5 to 2/5**; the marginal OOS uptick is short-block
OOS-fit, and a **constant** cut to the same average exposure matches it (a 20-draw **random** gate spans 3.60–4.17
...
- **Reachable here:** a diversified six-family book at full-sample Sharpe ≈ **4.38** net
  (+43.5%/yr on the brief's $500k at 1.15×, drawdown −7.3%,
  block-bootstrap MC-P5 **+3.91**) that meets **all five** targets on the window the brief
  scores — the final out-of-sample block (Sharpe **3.87**) — and **four of the five** on the full
  15-year window (Sharpe **4.38**, missing on Sharpe outside the 2.5–4.0 band). Vol-premium anchors the Sharpe;
...
- **The *reweighting* frontier, quantified** — it is the *weighting* axis that is capped; the VIX tail-timing
  ...
  **82.4%** *and* worst-month **−4.7%** together, which the weighting axis cannot do at
...
- **The crisis-alpha leg is still worth holding, but not at an earner's weight (§6c-ter).** Dropping it
  outright *raises* Sharpe to **+4.76** and CAGR to **+62.9%** — but that
...
- **Binding constraints:** costs/turnover kill 5m (and most 15m) sleeves; the surviving edge is
  **crypto-heavy** (no family spans both classes since trend was dropped), so the book carries crypto-regime risk (visible as the
  book's thinnest years — 2026 at +1.4 — positive but well below the
...
|---|---|---|
| 0 (shipped) | +3.96 / +49.7% / **−4.5%** / 81% | **+3.58** / +40% |
| 0.15 | +3.96 / +48.9% / −4.0% / 81% | +3.25 / +45% |
| 0.25 | +3.91 / +48.1% / −4.0% / 81% | +2.74 / +48% |
| 0.40 | +3.83 / +47.3% / −4.3% / 80% | +2.19 / +51% |
...
for +48.3% against +62.9% without it. Dropping it is not the answer either — that
...
|---|---|---|
| dropped entirely | +4.76 / +62.9% / −6.10% / 85% / 2 | 4/5 / +4.31 / +50.4% |
| one full slot (was shipped) | +3.91 / +48.3% / −4.50% / 81% / 3 | 5/5 / +3.58 / +39.9% |
| half a slot, constant | +4.38 / +54.4% / −5.20% / 83% / 3 | 5/5 / +3.98 / +44.4% |
| **ramped on market stress** (ships) | +4.36 / +55.5% / **−4.60%** / 85% / 2 | **5/5** / +3.96 / +45.4% |
...
(0.70 of a slot) at the times it pays for it**: 7.2% of CAGR on the full
window and 5.5% on the frozen block, a worst month of −4.60%, and
...
|---|---|---|
| ramped on market stress | **+55.5%** / **−4.60%** | **+45.4%** |
| the same ramp, rotated to the wrong days | +52.1% / −5.50% | +43.6% |
| held flat at the ramp's own average | +51.8% / −4.90% | +42.5% |
...
(Sharpe 4.30, months 79.3%, streak 3) and **3/5 on the frozen block** (Sharpe 4.09, months 76.9%).
...
|---|---|---|
| all eight | 2/5 — Sharpe 4.30 (over 4.0), months 79.3%, streak 3 | 3/5 — Sharpe 4.09 (over 4.0), months 76.9% |
| drop vol-premium | 0/5 — Sharpe 1.56 (under 2.5), months 58.0%, max−DD −23.2%, streak 13, worst month −9.8% | 3/5 — Sharpe 2.36 (under 2.5), months 76.9% |
| drop x-sect | 3/5 — Sharpe 4.50 (over 4.0), months 78.7% | 4/5 — Sharpe 3.90, months 73.1% |
| drop breakout | 2/5 — Sharpe 4.29 (over 4.0), months 78.7%, streak 3 | 3/5 — Sharpe 4.44 (over 4.0), months 76.9% |
| drop crisis | 3/5 — Sharpe 4.57 (over 4.0), streak 3 | 4/5 — Sharpe 4.33 (over 4.0) |
| drop global-macro | 2/5 — Sharpe 4.57 (over 4.0), streak 3, worst month −11.0% | **5/5** — Sharpe 3.93 |
| drop BAB | 3/5 — Sharpe 4.31 (over 4.0), streak 3 | 4/5 — Sharpe 4.07 (over 4.0) |
| drop trend | 4/5 — Sharpe 4.41 (over 4.0) | 4/5 — Sharpe 4.04 (over 4.0) |
| drop carry | 3/5 — Sharpe 4.23 (over 4.0), months 79.8% | 4/5 — Sharpe 3.97, months 76.9% |
...
**Eight of 37 clear the scored block, and that ratio is the point.** A
37-way search that returns eight survivors is weak evidence by construction,
...
|---|---|---|---|
| targets, full / block | 2/5 · 3/5 | 2/5 · 3/5 | **4/5 · 5/5** |
| Sharpe, full / block | 4.30 / 4.09 | 4.28 / 4.09 | 4.36 / **3.96** |
| **CAGR, full / block** | +47.3% / +37.5% | +55.9% / +44.3% | **+55.5% / +45.4%** |
| **P&L /yr on $500k** | $196k | $225k | **$224k** |
| book volatility | 9.5% | 10.9% | **10.9%** |
| max-DD / worst month | −6.5% / −3.4% | −7.5% / −4.3% | **−7.3% / −4.6%** |
| vol-premium share of P&L | 58% | — | **65%** |

**Returns did not fall — they rose.** At the shipped 1.15× the six-family book earns
**+8.3pp of CAGR more** on the full window and **+7.9pp more** on the scored block,
about **$28k/yr more** on the brief's $500k. The Sharpe fell because the book runs *hotter*: six
legs at equal risk are less diversified than eight, so volatility went from 9.5% to 10.9% and the
...
+0.3pp more on the full window and −1.1pp more on the block — so the honest
...
2/5 and 3/5 at that leverage, because the targets it misses are
...
58% to 65% of P&L against the tail it would carry ungated, and trend was the only family
...
unchanged — the leg is 71% of P&L, and gating it better does not make the book less
dependent on it.
...
**1. "A net Sharpe near 4.38 is not credible for a real book."** It would not be for a *sleeve*, and no sleeve here
...
still make Sharpe +1.38**, positive every year. If the number were a mining artifact it would
collapse there.
...
is **71% of P&L**. Three things bound it — it is sized on the tail rather than on its Sharpe (equal risk,
...
**±0.70**, stated in §5c — 3.87 is 3.87 ± 0.70. The length is a trade: at one year the ≤2-month streak
...
Sharpe 3.84** and pays for that history in drawdown (−14.5%).
...
is **5 of 5** — missing on nothing — and the full window is **4 of 5**, missing
...
worst month from −4.50% to −4.60% and the streak from
