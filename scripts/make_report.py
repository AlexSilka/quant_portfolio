...
def main():
    ...
    sc_note = (
        ...
        f'regime gates</b> &mdash; every sleeve on its own curve, and the VIX term structure over the thirteen '
        f'equity sleeves whose volatility it actually measures &mdash; and the crypto sleeve&rsquo;s '
        f'<b>residual momentum</b>.</li>'
