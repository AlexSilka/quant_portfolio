...
def main():
    ...
    sc_note = (
        ...
        f'regime gates</b> &mdash; the VIX term structure over all eighteen sleeves as a systemic-stress '
        f'read, plus each sleeve&rsquo;s own curve for the events the VIX cannot see &mdash; and the crypto '
        f'sleeve&rsquo;s <b>residual momentum</b>.</li>'
